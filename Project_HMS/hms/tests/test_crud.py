...
def test_create_patient(client):
    patient = {"id": 1, "name": "Bob", "age": 40, "disease": "Flu"}
...
def test_read_all_patients(client):
    patient = {"id": 2, "name": "Sumit", "age": 30, "disease": "Diabetes"}
...
def test_update_patient(client):
    patient = {"id": 3, "name": "Dravid", "age": 50, "disease": "Asthma"}
    client.post("/patients", data=json.dumps(patient), content_type="application/json")

    updated_patient = {"id": 3, "name": "Dravid", "age": 30, "disease": "Asthma"}
...
def test_delete_patient(client):
    patient = {"id": 4, "name": "John", "age": 50, "disease": "Cancer"}
    client.post("/patients", data=json.dumps(patient), content_type="application/json")
